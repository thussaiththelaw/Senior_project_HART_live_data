...
try:
	...
	while True:
		...
		if data:
			...
			print(data)
			with open('home/vaughn/Documents/text.txt','a') as file:
				file.write(data)
		time.sleep(3)
		...
		subprocess.Popen('obexftp --nopath --noconn --uuid none --bluetooth 0C:02:BD:89:E4:B1 --channel 12 -p home/vaughn/Documents/text.txt', shell=True)
		time.sleep(57)
